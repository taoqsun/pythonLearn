...
class ClientThread( threading.Thread ):
    ''' 
    Class that implements the client threads in this server4
    '''
...
class Server:
    ...
    def run( self ):
        '''
        Server main loop. 
        Creates the server4 (incoming) socket, and listens on it of incoming
        ...
        while not all_good:
            ...
            try:
                ...
                #
                self.sock.bind( ( '10.224.74.181', 52000 ) )
                #
                # Listen for incoming connections. This server4 can handle up to
        ...
        print
        print "typing 'bye' finishes the thread, but not the server4 ",
        print "(eg. you can quit telnet, run it again and get a different ",
        print "thread name"
        print "typing 'quit' finishes the server4"
...
if "__main__" == __name__:
    ...
    print "Terminated"
#该代码片段来自于: http://www.sharejs.com/codes/python/2356